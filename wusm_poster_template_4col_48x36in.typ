...
//
//  Landscape, 48 in x 36 in, 0.75 in margins, four-column layout.
//
...
#let title-col-w  = 35in // controls the width of the center block
  ...
  #grid(
    ...
    // center: title / authors / affiliations
    {
      ...
      set par(spacing: 0em)
      {
        ...
        set text(font: title-font, size: 115pt, weight: "bold", fill: black)
        title
      }
      v(2em)
      {
        set par(justify: false)
        set text(font: title-font, size: 56pt, weight: "semibold", fill: ink)
        authors
      }
      v(0.6em)
      {
        set par(justify: false)
        set text(font: heading-font, size: 38pt, fill: ink)
        affiliations
      }
    },
